...
use App\Http\Controllers\Ui\OrdersController as UiOrdersController;
...
Route::controller( UiOrdersController::class )->prefix( 'orders' )->group( function( ) {
	Route::get( '/', 'index' )->name( 'page_orders' );
	Route::get( '/add', 'add' );
